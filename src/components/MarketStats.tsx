...
export default function MarketStats() {
  return (
    <section className="relative py-24 md:py-32 px-4" style={{ background: 'linear-gradient(180deg, transparent, rgba(34,197,94,0.03), transparent)' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[#4ade80] text-xs font-bold tracking-[0.3em] uppercase mb-3 block">
        ...
        <div className="glass-glow rounded-2xl p-8 md:p-12 text-center mb-12 relative overflow-hidden">
          <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at center, #22c55e, transparent 70%)' }} />
          <p className="relative text-[#94a3b8] text-xs tracking-[0.3em] uppercase mb-4">Pre-Seed Raise</p>
          <p className="relative font-mono text-5xl md:text-7xl text-white mb-2" style={{ textShadow: '0 0 40px rgba(34,197,94,0.4)' }}>
            {config.fundingAsk}
          </p>
          ...
          <div className="relative flex flex-wrap justify-center gap-4 text-xs">
            <span className="px-3 py-1 rounded-full bg-[#22c55e]/10 border border-[#22c55e]/30 text-[#22c55e]">Pre-Money: {config.valuation}</span>
            <span className="px-3 py-1 rounded-full bg-[#4ade80]/10 border border-[#4ade80]/30 text-[#4ade80]">Equity: {config.equityOffered}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {config.traction.map((t, i) => {
            ...
            const statusColors = {
              ...
              'in-progress': { bg: 'rgba(74,222,128,0.1)', border: 'rgba(74,222,128,0.3)', text: '#4ade80' },
              upcoming: { bg: 'rgba(22,163,74,0.1)', border: 'rgba(22,163,74,0.3)', text: '#16a34a' },
            };
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {config.projectedRevenue.map((rev) => (
              <div key={rev.year} className="rounded-xl p-5 border border-[#22c55e]/20 bg-[#22c55e]/5">
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { label: 'Strong', val: '$10M', return: '$2.0M', multiple: '8x', color: '#4ade80' },
        ...
        <div className="text-center">
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #22c55e, #4ade80)', boxShadow: '0 0 30px rgba(34,197,94,0.3)' }}
          >
