    ...
    <section className="relative py-24 md:py-32 px-4 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[#22c55e] text-xs font-bold tracking-[0.3em] uppercase mb-3 block">
            The House of GHOUL
          </span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
          {ALL_GHOULS.map((g) => {
            ...
            return (
              ...
              >
                {isCurrent && (
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 text-[9px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-full bg-[#22c55e] text-white">
                    You Are Here
                  </span>
                )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {[
            ...
            <div key={stat.label} className="glass rounded-xl p-5 text-center">
              <p className="font-mono text-3xl md:text-4xl text-[#22c55e] mb-1">{stat.value}</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #22c55e, #00f0ff)' }}
          >
