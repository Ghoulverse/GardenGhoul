      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="glass-glow rounded-2xl p-8 relative overflow-hidden">
            <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at top right, #22c55e, transparent 70%)' }} />
            <div className="relative">
              ...
              <div className="flex flex-wrap items-center gap-2">
                {config.ipClasses.map((cls) => (
                  <div key={cls} className="flex items-center gap-1.5 text-[#22c55e] text-xs bg-[#22c55e]/10 border border-[#22c55e]/20 rounded-full px-3 py-1">
